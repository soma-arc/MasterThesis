...
Moreover, it is used to draw an tiling of the fundamental domain.
...
point of the word. 
We decide the maximum depth of traversing in advance, and
obtain words.
Next, we apply obtained words to the preselected fixed points.
