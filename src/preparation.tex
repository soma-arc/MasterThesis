...
%\par When the $G$-action is properly discontinuous, 
...
%\par In this paper, we consider a M\"obius transformations in a broad sense, that is,
...
%\par An extended M\"obius transformation induces an isometric mapping 
...
% $\displaymode \limit{i\to\infty} g_i(z_0) = p$.
