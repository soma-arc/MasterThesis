...
% This map $\varphi$ is a homomorphism and it gives an equivalence of actions.
% In the sequel, we regard the set of linear fractional transformations
...
%%***************ここまでみた20190107-2132****遡って加筆もしているので注意してください．
