...
Before we traverse the graph, we decide the maximum depth of the
traversing in advance.
...
The cats are transformed by a M\"obius transformation.
In Figure \ref{fig:circOrbit}, we draw an orbit of four disks.
